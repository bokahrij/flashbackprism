# FlashbackPrism SSL Self Signed
This fork lets you use self signed certificates on your own server and allows a specific port for https, ie https://mydomain:3232.
